// controllers/seed_list_controller.dart (ĐÃ CẬP NHẬT)
...
class SeedListController extends GetxController {
  ...
  void _fetchBrandsFromCache() {
    // Lấy 'brand' từ các sản phẩm có category là 'seeds'
    final fetchedBrands = _allStoreProducts
        .where((p) => p.product.category == 'seeds')
  ...
  void filterProducts() {
    ...
    var filteredList = _allStoreProducts.where((storeProduct) {
      ...
      // 1. Lọc theo Category
      final bool isCategoryMatch = storeProduct.product.category == 'seeds';
