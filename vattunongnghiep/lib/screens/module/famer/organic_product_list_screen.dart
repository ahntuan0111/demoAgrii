// screens/organic_product_list_screen.dart (ĐÃ CẬP NHẬT HOÀN CHỈNH)
...
import '../../../models/product_model.dart'; // <-- 2. Import model Product
import '../../../routes/app_routes.dart';

// 3. CHUYỂN SANG GETVIEW
class OrganicProductListScreen extends GetView<OrganicProductListController> {
  const OrganicProductListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // 4. KHÔNG CẦN Get.put() hay initState/dispose
    //    'controller' đã có sẵn từ GetView
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                // (Đã xóa 2 dropdown 'Type' và 'Stock')
              ],
            ),
          ),
          // Product list
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      ...
                      '${storeProduct.product.brand} · ${storeProduct.product.status == 'active' ? "Còn hàng" : "Hết hàng"}',
...
// Custom Dropdown Widget (tái sử dụng)
class _FilterDropdown extends StatelessWidget {
  final String value;
  final List<String> items;
  final ValueChanged<String?> onChanged;
  final String? prefix; // Thêm prefix
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: DropdownButton<String>(
        ...
        onChanged: onChanged,
        // Cập nhật để xử lý danh sách brand là RxList
