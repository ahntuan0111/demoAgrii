// screens/tool_list_screen.dart (ĐÃ CẬP NHẬT)
...
class ToolListScreen extends GetView<ToolListController> {
  const ToolListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // 4. KHÔNG CẦN INITSTATE/DISPOSE
    final currencyFormatter =
    NumberFormat.currency(locale: 'vi_VN', symbol: '₫'); // <-- SỬA LẠI SYMBOL
          ...
          Expanded(
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemCount: controller.productList.length, // Dùng productList
...
// Custom Dropdown Widget for filters (Giữ nguyên)
